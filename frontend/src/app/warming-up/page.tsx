...
export default function UnderConstructionPage() {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden flex flex-col">
      ...
      {/* Main content */}
      <div className="relative z-10 flex flex-col items-center justify-center flex-1 px-4 py-4 md:py-6 text-center">
        {/* Basketball & Hoop Animation - Compact responsive scaling */}
        <div className="relative w-[280px] h-[224px] sm:w-[320px] sm:h-[256px] md:w-[400px] md:h-[320px]">
          {/* Backboard - z-10 */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[168px] h-[112px] sm:w-[192px] sm:h-[128px] md:w-[256px] md:h-[160px] bg-card border-2 border-border rounded-lg shadow-lg z-10">
            {/* Logo inset in backboard square */}
            <div className="absolute bottom-1.5 sm:bottom-2 left-1/2 -translate-x-1/2 w-16 h-14 sm:w-20 sm:h-[70px] md:w-28 md:h-24 border border-primary rounded overflow-hidden flex items-center justify-center bg-[#1a1614]">
              <Image
          ...
          <div className="absolute animate-shoot">
            <svg
              viewBox="0 0 50 50"
              className="w-[55px] h-[55px] sm:w-[64px] sm:h-[64px] md:w-[88px] md:h-[88px] drop-shadow-lg"
            >
          ...
          <div className="absolute top-[106px] sm:top-[120px] md:top-[152px] left-1/2 -translate-x-1/2 z-20">
            <div className="w-[70px] h-[11px] sm:w-20 sm:h-3 md:w-28 md:h-4 bg-primary rounded-full shadow-md" />
            {/* Net */}
            <svg
              viewBox="0 0 80 60"
              className="w-[70px] h-[52px] sm:w-20 sm:h-[60px] md:w-28 md:h-20 -mt-0.5 animate-net"
            >
              <path
        ...
        {/* Text */}
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 md:mb-3 bg-gradient-to-br from-foreground to-primary bg-clip-text text-transparent animate-gradient bg-[length:200%_200%]">
          Pre-Game Warmups.
        </h1>

        <p className="text-base md:text-lg text-muted-foreground mb-4 md:mb-6 max-w-md">
          We're getting loose before the big reveal. The official 2026 season
          site is coming soon.
        </p>

        {/* Progress bar */}
        <div className="w-56 md:w-72 mb-4 md:mb-6">
        ...
        {/* Email Capture Form */}
        <div className="w-full max-w-sm md:max-w-md mb-4 md:mb-6">
        ...
        <div className="flex flex-wrap justify-center gap-3 md:gap-5">
          ...
          >
            ...
            <span className="text-xs md:text-sm">@njstarselite_aau</span>
          </a>
          ...
          >
            ...
            <span className="text-xs md:text-sm">201-410-6957</span>
          </a>
          ...
          >
            ...
            <span className="text-xs md:text-sm">njstarsbasketball@gmail.com</span>
          </a>
        </div>

        {/* Footer */}
        <p className="mt-4 md:mt-6 text-xs md:text-sm text-muted-foreground/60">
