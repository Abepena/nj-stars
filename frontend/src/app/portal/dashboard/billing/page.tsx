 ...
 *
 * Billing & dues management for the dashboard tab navigation.
 */
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            {hasBalance && (
              <div className="flex flex-col sm:flex-row gap-2">
                <Link href="/portal/dashboard/billing/pay">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Link href="/portal/dashboard/billing/payment-methods">
        ...
        <Link href="/portal/dashboard/billing/history">
          <Card className="hover:border-primary/50 transition-colors cursor-pointer h-full">
            <CardContent className="flex items-center gap-4 p-5">
              <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
        ...
        <Link href="/portal/dashboard/credits">
          <Card className="hover:border-primary/50 transition-colors cursor-pointer h-full">
            <CardContent className="flex items-center gap-4 p-5">
              <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
        ...
        <CardContent>
          {data.saved_cards.length === 0 ? (
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="/portal/dashboard/billing/payment-methods" className="text-primary hover:underline">
                Add a card
              </Link>
            </p>
          ) : autoPayEnabled ? (
