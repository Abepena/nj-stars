...
export default function UnderConstructionPage() {
  ...
  useEffect(() => {
    ...
    const totalDays = (newYear2026.getTime() - startOf2025.getTime()) / (1000 * 60 * 60 * 24)
    const daysPassed = (now.getTime() - startOf2025.getTime()) / (1000 * 60 * 60 * 24)
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center flex-1 px-4 text-center">
        ...
        {/* Basketball & Hoop Animation - Scaled Up 1.6x */}
        <div className="relative w-[512px] h-[410px] md:w-[640px] md:h-[512px]">
          {/* Backboard - z-10 */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[307px] h-[205px] md:w-[410px] md:h-[256px] bg-card border-4 border-border rounded-lg shadow-lg z-10">
            {/* Logo inset in backboard square */}
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-32 h-28 md:w-44 md:h-36 border-2 border-primary rounded overflow-hidden flex items-center justify-center bg-[#1a1614]">
              <Image
          ...
          <div className="absolute animate-shoot">
            <svg viewBox="0 0 50 50" className="w-[100px] h-[100px] md:w-[140px] md:h-[140px] drop-shadow-lg">
          ...
          <div className="absolute top-[192px] md:top-[243px] left-1/2 -translate-x-1/2 z-20">
            <div className="w-32 h-5 md:w-44 md:h-6 bg-primary rounded-full shadow-md" />
            {/* Net */}
            <svg
              viewBox="0 0 80 60"
              className="w-32 h-24 md:w-44 md:h-32 -mt-1 animate-net"
            >
              <path
        ...
        <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-md">
          We're getting loose before the big reveal.
          The official 2026 season site is coming soon.
        </p>
